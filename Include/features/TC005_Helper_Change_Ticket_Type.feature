Feature: Change Ticket Type
	...
	@positive_case @change_ticket
	Scenario: Helper change ticket from Other to Deposit
	...
	And Helper click button Change Ticket Type
	And Helper see popup of Change Ticket Type
	And Helper choose ticket type Deposit
	And Helper click button Send on popup
